...
```yaml
openapi-type: arm
tag: package-YYYY-MM-DD	tag: package-2020-09-23
```

### Tag: package-2020-09-23

These settings apply only when `--tag=package-2020-09-23` is specified on the command line.

```yaml $(tag) == 'package-2020-09-23'
input-file:
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-azureresourceschema
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianenalertsmanagement']
```
