...
This is the AutoRest configuration file for tianenattestation.
...
These are the global settings for the tianenattestation.

```yaml
openapi-type: arm
tag: package-YYYY-MM-DD	tag: package-2020-09-27
```

### Tag: package-2020-09-27

These settings apply only when `--tag=package-2020-09-27` is specified on the command line.

```yaml $(tag) == 'package-2020-09-27'
input-file:
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-azureresourceschema
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianenattestation']
```
