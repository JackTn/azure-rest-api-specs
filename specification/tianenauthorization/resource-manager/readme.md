...
This is the AutoRest configuration file for tianenauthorization.
...
These are the global settings for the tianenauthorization.
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-js
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianenauthorization']
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js tianenauthorization/resource-manager
```
