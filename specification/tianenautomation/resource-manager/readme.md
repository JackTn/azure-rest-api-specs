...
This is the AutoRest configuration file for tianenautomation.
...
These are the global settings for the tianenautomation.
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-ruby
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianenautomation']
```
