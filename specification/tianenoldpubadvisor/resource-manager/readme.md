...
This is the AutoRest configuration file for tianenoldpubadvisor.
...
These are the global settings for the tianenoldpubadvisor.
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-js
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianenoldpubadvisor']
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js tianenoldpubadvisor/resource-manager
```
