...
This is the AutoRest configuration file for tianentdvisor.
...
These are the global settings for the tianentdvisor.
...
swagger-to-sdk:
  ...
  - repo: azure-sdk-for-js
    after_scripts:
      - bundle install && rake arm:regen_all_profiles['azure_mgmt_tianentdvisor']
  - repo: azure-resource-manager-schemas
    after_scripts:
      - node sdkauto_afterscript.js tianentdvisor/resource-manager
```
